...
// Get user's chats
router.get('/chats', authenticate(['user', 'premium']), async (req: Request, res: Response) => {
  try {
...
// Get user's groups
router.get('/groups', authenticate(['user', 'premium']), async (req: Request, res: Response) => {
  try {
...
router.get('/messages', authenticate(['user', 'premium']), async (req: Request, res: Response) => {
  try {
