...
export default function MentorInvitation() {
  ...
  const handleAcceptInvitation = async (token: string) => {
    try {
      await MentorService.acceptInvite(token);
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground text-sm md:text-base">
              We're excited to invite you to join our mentorship platform. Your expertise
              and experience would be invaluable to our community of learners.
            </p>
          </div>
